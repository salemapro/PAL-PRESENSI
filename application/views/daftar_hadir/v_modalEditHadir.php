            ...
            <?php echo form_open('presensi/updateDataHadir', ['class' => 'formEditHadir']) ?>
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="inputIntansi" name="intansi" value="<?= $intansi; ?>">
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="datetime-local" class="form-control" id="inputAttend" name="attendance" value="<?= $attendance; ?>">
                        </div>
                    </div>
                </div>
